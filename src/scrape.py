...
class Scrape():
    ...
    def __init__(self, years: list, dbname):
        ...
        self.team_dic = {'Dallas': 'DAL', 'Boston': 'BOS', 'Toronto': 'TOR',
                        'Denver': 'DEN', 'Philadelphia': 'PHI', 'New York': 'NYK',
                        'Orlando': 'ORL', 'Cleveland': 'CLE', 'Detroit': 'DET',
                        ...
                        'Indiana': 'IND', 'Portland': 'POR', 'Brooklyn': 'BRK',
                        'Golden State': 'GSW', 'Chicago': 'CHI', 'LA Lakers':
                        'LAL', 'Memphis': 'MEM', 'Atlanta': 'ATL', 'Utah': 'UTA',
                        'Minnesota': 'MIN'}

        self.sp = {'BOS': '20722', 'PHI': '20731', 'BRK': '20749', 'NYK':
